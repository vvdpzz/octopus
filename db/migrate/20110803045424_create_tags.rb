class CreateTags < ActiveRecord::Migration
  def self.up
    create_table :tags do |t|
       ...
       t.integer :uuid, :integer, :limit => 5, :null=> false # uses MySQL bigint, stored in redis
       t.string :name, :null => false
       t.integer :area_id, :null => false #format is 00, eg: 01 => 'computing'
       t.string :area_name, :null => false
       t.integer :group_id, :null => false, :default => 0 #000 means this is a recored for area, format is 000, eg: 001 => 'programming language'
